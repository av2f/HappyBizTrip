...
final class Version20200714164312 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user_connect (requester_id INT NOT NULL, requested_id INT NOT NULL, request_at DATETIME NOT NULL, state VARCHAR(1) NOT NULL, INDEX IDX_74CFF91FED442CF4 (requester_id), INDEX IDX_74CFF91F983624B7 (requested_id), PRIMARY KEY(requester_id, requested_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
